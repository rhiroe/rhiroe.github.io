...
import { getAllPresentations, type Presentation } from '~/lib/getPresentations'
...
const PresentationsPage: NextPage<Props> = ({ presentations }) => {
  return (
    <Box component="div">
      <Head>
                    ...
                    <Box
                      ...
                      sx={{
                        ...
                        '&::after': {
                          ...
                          borderBottom: { xs: '12px solid transparent', md: '15px solid transparent' },
